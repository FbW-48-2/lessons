...
console.log(array_1.push("Tommy", "Max"));
console.log("array_1 ==> ", array_1); // [ 'Tommy', 'Max' ]

array_1.push("Pilar");
console.log("array_1 ==> ", array_1); // [ 'Tommy', 'Max', 'Pilar' ]
...
console.log(array_2.pop()); // Max

console.log("array_2 ==> ", array_2); // [ 'ABC', 100 ]
array_2.pop();
console.log("array_2 ==> ", array_2); //  [ 'ABC' ]
